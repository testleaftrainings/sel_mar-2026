3:00 to 3:30 ---> Methods & Objects
3.30 to 4.15 ---> Selenium Introduction
4:15 to 4:35 ---> Breakout
4:35 to 4:45 ---> Break
4:45 to 5:30 ---> BasicLocators
5:30 to 5:50 ---> Breakout
5:50 to 6:10 ---> Recap

AccessModifiers:
1)public--access the methods across different classes of same package,diffrent package,diffrent projects
2)private--can access only within the class of that method
3)protected--->applicable for inheritance
4)default--->access the method across different classes of the same package.

//how to open the dom in the application
1)fn+f12
2)ctrl+shift+I
3)do right click and inspect the field
