3:00 to 3:15 ---> MentorIntroduction
3.15 to 4:00 ---> CoreJavaIntroduction
4:00 to 4:20 ---> Breakout
4:20 to 4:30 ---> Break
4:30 to 5:15 ---> Datatypes
5:15 to 5:35 ---> Breakout
5:35 to 6:00 ---> Operators and control statements
...
A)primitive datattype(predefined)--->size is defined already

1)WholeNUmbers(Integer)
-byte(8bit)
-short(16bit)---5digits
-int(32bit)-->1 to 9 digits
-long(64bit)-->more than 9 digits
2)decimal 
-float
-double
3)char--to store a single character
4)boolean-returns true or false
B)Non-Primitive(userdefined)-->size is not predefined
